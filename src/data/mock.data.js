...
// 全量版本器件库
export const versionedComponentData = {
    'V1.0': {
...
export const versionDiffLibrary = {
    'V2.0-vs-V1.0': {
...
export const presetAnnotations = [
    // ============ V1.0 历史基线 ============
    {
